...
namespace OOTTracker.Migrations
{
    ...
    [Migration("20240822031838_AddSpoilerMapping")]
    partial class AddSpoilerMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OOTTracker.Data.InventoryEquipment", b =>
                {
                    ...
                    b.Property<Guid?>("InventoryEquipmentCategoryId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InventoryEquipmentCategoryId");

                    b.ToTable("InventoryEquipment");
                });

            modelBuilder.Entity("OOTTracker.Data.InventoryEquipmentCategory", b =>
                {
                    b.Property<Guid>("InventoryEquipmentCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("InventoryEquipmentCategoryId");

                    b.ToTable("InventoryEquipmentCategories");
                });
            ...
            modelBuilder.Entity("OOTTracker.Data.SpoilerMapping", b =>
                {
                    b.Property<Guid>("SpoilerMappingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SpoilerMappingId");

                    b.HasIndex("ItemCheckId");

                    b.ToTable("SpoilerMappings");
                });
            ...
            modelBuilder.Entity("OOTTracker.Data.InventoryEquipment", b =>
                {
                    b.HasOne("OOTTracker.Data.InventoryEquipmentCategory", "InventoryEquipmentCategory")
                        .WithMany("InventoryEquipmentItems")
                        .HasForeignKey("InventoryEquipmentCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.Navigation("InventoryEquipmentCategory");
                });
            ...
            modelBuilder.Entity("OOTTracker.Data.InventoryEquipmentCategory", b =>
                {
                    b.Navigation("InventoryEquipmentItems");
                });
